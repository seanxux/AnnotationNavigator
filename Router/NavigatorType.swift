...
//            .home, .messageCenter, .shareQuick, .cart, .mine
//        ]
//        if types.contains(router.type) {
//            guard let topViewController = UIViewController.topMost,
//                let tabBarControllerType = topViewController as? JYFTabBarControllerType,
...
//            case .shareQuick:
//                navigator.present(.shareQuick, wrap: UINavigationController.self)
//            case .cart:
